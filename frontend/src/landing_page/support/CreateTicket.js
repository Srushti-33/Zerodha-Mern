    ...
    <div className="container">
      <div className="row p-5 mt-5 mb-5">
        <h1 className="fs-2 text-center">
         To ceate a ticket, select a relevant topic
        </h1>
      ...
      <div className="col-4 p-5 mt-5 mb-5">
        <h4 className="">
         ...
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Company, partnership and HUF Account Opening</a><br></br>
      ...
      <div className="col-4 p-5 mt-5 mb-5">
        <h4 className="">
         <i class="fa fa-user" aria-hidden='true'></i>Your Zerodha Account</h4>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Login Cardentials  </a><br></br>
      ...
      <div className="col-4 p-5 mt-5 mb-5">
        <h4 className="">
         <i class="fa fa-bar-chart" aria-hidden='true'></i>Your Zerodha Account</h4>
         ...
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Pi and other paltforms</a><br></br>
         ...
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>GTT</a><br></br>
            ...
            <div className="col-4 ">
        <h4 className="">
         <i class="fa fa-credit-card" aria-hidden='true'></i>Funds</h4>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Margin/leverage, Product and Order types</a><br></br>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Kite Web and Mobile</a><br></br>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Trading FAQs</a><br></br>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Corporate Actions</a><br></br>
      ...
      <div className="col-4 ">
        <h4 className="">
         <i class="fa fa-circle-o-notch" aria-hidden="true"></i>Console</h4>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Margin/leverage, Product and Order types</a><br></br>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Kite Web and Mobile</a><br></br>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Trading FAQs</a><br></br>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Corporate Actions</a><br></br>
      ...
      <div className="col-4 ">
        <h4 className="">
         <i class="fa fa-gg-circle" aria-hidden='true'></i>Coin</h4>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Margin/leverage, Product and Order types</a><br></br>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Kite Web and Mobile</a><br></br>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Trading FAQs</a><br></br>
         <a href='' style={{textDecoration:"none", lineHeight:"2.5"}}>Corporate Actions</a><br></br>
