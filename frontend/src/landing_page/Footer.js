  ...
  return (
    ...
    <div className="container border-top mt-5 ">
      <div className="row mt-5">
        <div className="col">
          <img
            ...
            alt="small-logo"
          ></img>
          <p className="mt2">&copy; 2010-2024, Not Zerodha Broking Ltd. All rights reserved.</p>
        </div>
        ...
        <div className="col">
          ...
          <br></br>
          <a href=""className="text-muted" style={{textDecoration:"none"}}>Refferal Programme</a>
          <br></br>
      ...
      <p>
        ...
        any complaints pertaining to securities broking please write to [email
        protected], for DP related to [email protected]. Please ensure you
       ...
       <p>
        ...
        redressal of the grievances Smart Online Dispute Resolution | Grievances
        Redressal Mechanism
        </p>
      ...
      <p>
        ...
        issued by NSDL/CDSL every month. India's largest broker based on
        networth as per NSE. NSE broker factsheet
      </p>
